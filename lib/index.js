...
function currentElement(data) {
  var text = '<ul class="card"><li>'+data.city+'</li><li>'+data.country+'</li><li>'+data.currently.time+'</li><li>Precipation:'+data.currently.preciporcentage+' %</li><li>'+data.currently.summary+'</li><li>Temperature:'+data.currently.temp+'</li></ul>'
  $('.summary').append(text)
}
